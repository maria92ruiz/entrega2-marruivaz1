...
/*
INSERT INTO Departments (departmentId,firstname) VALUES
(1,'Departamento de Tecnología Electrónica'),
(2,'Ciencias de la computación e Inteligencia Artificial'),
(3,'Lenguaje y Sistemas Informaticos');

*/
INSERT INTO Tutorials(tutorialId,day,initHour,endHour) VALUES 
(1,'Lunes','11:15:00','11:30:00'),
(2,'Martes','12:00:00','12:30:00'),
(3,'Lunes','13:15:00','13:30:00');

INSERT INTO Teachers(teacherId,dni,firstName,surname,birthDate,email,tutorialId,departmentId) VALUES
(1,'47393243h','Maria','Ruiz','1970-10-23','marruivaz1@us.es',1,2);

INSERT INTO StudentsTutorials(studentTutorialId,studentId,tutorialId) VALUES
(1,10,3);
